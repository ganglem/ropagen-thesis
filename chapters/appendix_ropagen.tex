...
% TODO: insert screenshot PNG (Emilija to supply)
\fbox{\parbox[c][6cm][c]{0.85\linewidth}{\centering\itshape Screenshot placeholder --- to be inserted.}}
\caption{Ask mode. Each section presents a free-form text field (no checkboxes) paired with a per-section chat panel that explains the section's purpose and answers follow-up questions. The model's reply may include a \texttt{DATA\_UPDATE} block that the front-end uses to auto-populate the corresponding text field.}
\end{figure}
