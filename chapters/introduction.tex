...
central findings (the completeness--hallucination tradeoff and
the confidence--quality gap) against the related work and names
the study's limitations.
\textbf{Chapter~\ref{ch:conclusion}} (Conclusion) answers RQ1
and RQ2 in plain English and draws the design implications for
LLM-assisted compliance tooling that follow.
