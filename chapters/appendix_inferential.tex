...
user-study tests use $n = 69$ (matched within-subjects, Friedman +
...
first, followed by the user-study inferential tests, the NLP
...
and document-quality measures, computed on the user-study~$\times$~NLP joined
