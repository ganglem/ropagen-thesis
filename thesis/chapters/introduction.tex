...
\section{Reserach Problem and Research Questions}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Document quality assessment (BERTScore, LLM-as-a-judge)
    \end{itemize}
    
    \item \textbf{Chapter 5: Evaluation and Results}
    \begin{itemize}
        \item RQ1: User experience and preferences
        \item RQ2: Document quality and confidence-quality gap
    \end{itemize}
    
    \item \textbf{Chapter 6: Discussion}
    \begin{itemize}
        \item Interpretation of findings and implications
