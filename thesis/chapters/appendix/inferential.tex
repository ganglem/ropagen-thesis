...
referenced in Chapters~\ref{ch:userstudy},~\ref{ch:docquality},
and~\ref{ch:discussion}. The within-subjects user-study tests
...
and, for completeness, for \textit{SUS} and the R-TLX composite. Sign convention:
...
mode-rank level: Chat is tied at the top with Ask on the perceived
confidence composite and uniquely highest on item $5_{ai}$, yet
lowest on judge legal correctness; Form is lowest on both
confidence measures and tied with Ask for highest on judge legal
correctness.
