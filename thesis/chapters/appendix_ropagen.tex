...
The three figures below show the ROPAgen user interface as it appeared to participants in each of the three interaction modes, captured on a comparable step of the standardized study scenario (Section~\ref{app:scenario}). They illustrate the user-facing surface of each mode rather than the backend behavior reproduced in Section~\ref{app:ropagen-prompts}.
