...
\input{chapters/appendix_ropagen}                  % A: ROPAgen + LLM-as-a-Judge Configuration
\input{chapters/appendix_materials_descriptives}   % B: Study Materials + Demographics + Per-Item Tables
\input{chapters/appendix_inferential}              % C: Inferential Statistics
\input{chapters/appendix_acronyms}                 % D: Acronyms
